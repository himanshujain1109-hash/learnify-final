...
export class SpeechService {
  ...
  public speak(
    ...
    if (this.isMuted) {
      ...
      const durationMs = (text.split(' ').length / 2.5) * 1000;
    ...
    // Set pitch: male slightly lower (0.9), female slightly clearer (1.05) if not specified
    ...
    utterance.onboundary = (e) => {
      if (e.name === 'word' && this.onWordCallback) {
