  ...
  private loadPersistedUser() {
    ...
    try {
      ...
      if (stored) {
        ...
        // Default authenticated user matching user request and screenshot
        this.currentUser = {
          id: 'user_himanshu',
          email: 'hjtj2234@gmail.com',
          name: 'himanshu',
          avatarUrl: 'https://api.dicebear.com/7.x/initials/svg?seed=himanshu&backgroundColor=6366f1',
