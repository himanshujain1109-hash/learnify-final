        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <h1 className="text-3xl sm:text-4xl font-black tracking-tight text-slate-950 flex items-center gap-2">
              {currentUser ? (
                ...
                <>
                  <span>Welcome to Learnify AI</span>
                  <span className="text-3xl">✨</span>
                </>
              )}
            </h1>
            <p className="text-sm sm:text-base text-slate-500 mt-1 font-normal">
              {currentUser
                ...
                : 'Sign in to access your saved study materials, notes, and AI video lectures.'}
            </p>
          </div>
          ...
          <div className="flex items-center gap-2.5 flex-wrap">
            {currentUser ? (
              <button
                onClick={onOpenAuth}
                className="px-3.5 py-2.5 rounded-xl bg-white hover:bg-slate-50 border border-slate-200 text-xs font-bold text-slate-700 flex items-center gap-2 shadow-2xs transition-colors"
              ...
              <button
                onClick={onOpenAuth}
                className="px-4 py-2.5 rounded-xl bg-indigo-50 hover:bg-indigo-100/80 text-[#6366f1] border border-indigo-200 font-bold text-xs flex items-center gap-1.5 shadow-2xs transition-colors"
              >
